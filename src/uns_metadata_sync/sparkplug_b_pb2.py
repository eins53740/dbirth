...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 6, 32, 0, "-rc2", "sparkplug_b.proto"
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    ]._serialized_start = 717
    _globals["_PAYLOAD_TEMPLATE_PARAMETER_PARAMETERVALUEEXTENSION"]._serialized_end = (
        752
    )
    ...
    ]._serialized_start = 1181
    _globals["_PAYLOAD_DATASET_DATASETVALUE_DATASETVALUEEXTENSION"]._serialized_end = (
        1214
    )
